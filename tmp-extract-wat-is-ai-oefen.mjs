...
const docx = path.join(
  root,
  'SVdocs/SS1B5-smartium/Week 7/Casus 14 - AI in de zorg/LMO Wat is Ai_ oefenvragen.docx'
)
const zip = path.join(os.tmpdir(), 'wat-is-ai-oefen.zip')
const tmp = path.join(os.tmpdir(), 'wat-is-ai-oefen-unzip')
...
fs.writeFileSync(path.join(root, 'wat-is-ai-oefen-paras.json'), JSON.stringify(paras, null, 2), 'utf8')
