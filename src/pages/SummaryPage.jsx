...
// LME 3: Extremiteiten en Gewrichtsleer Content
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div className="text-left">
                  ...
                  <p className="text-sm text-slate-500">1 week · 2 casussen · 3 LME's</p>
                </div>
              </div>
                          ...
                          <div className="flex items-center justify-between p-3 rounded-xl bg-accent-50 border border-accent-200 hover:border-accent-300 transition-colors">
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                ...
                                <p className="text-xs text-accent-600">52 meerkeuzevragen</p>
                              </div>
                            </div>
