// Week 6 Casus 12 LME 4 - Afbeelding 10: Preventieve maatregelen lijst
export const image10PreventieveMaatregelenLijstQuestions = [
  {
    id: 1,
  ...
  {
    id: 2,
    question: "Welke maatregel draagt bij aan het voorkomen van POWI?",
    options: [
      { letter: "A", text: "Handhygiëne" },
      { letter: "B", text: "Geen isolatie van besmettelijke patiënten" },
      { letter: "C", text: "Vuile kamers niet reinigen" },
      { letter: "D", text: "Geen persoonlijke beschermingsmiddelen" },
    ],
    correctAnswer: "A",
    category: "Preventie",
  },
