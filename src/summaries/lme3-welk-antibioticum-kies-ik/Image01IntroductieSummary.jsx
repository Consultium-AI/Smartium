...
const Image01IntroductieSummary = () => {
  ...
  return (
    <SummaryLayout
      ...
      practiceLink="/oefenvragen?lme=lme3-welk-antibioticum-kies-ik-image01"
    >
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <div className="p-5 bg-primary-50 rounded-xl border border-primary-200">
            ...
            <ul className="list-disc pl-6 space-y-1 text-primary-700 text-sm">
              <li>Uitleggen wat antimicrobiele gevoeligheid is</li>
              <li>Het verschil uitleggen tussen empirische en gerichte therapie, en wat met profylaxe bedoeld wordt</li>
              <li>Uitleggen wat farmacodynamiek en -kinetiek inhouden, en welke rol zij spelen in de antimicrobiele therapie</li>
              <li>Beargumenteren met welke factoren rekening gehouden moet worden bij het kiezen van het juiste antimicrobiele middel</li>
            </ul>
          </div>
          ...
          <div className="p-5 bg-amber-50 rounded-xl border border-amber-200">
            ...
            <ul className="list-disc pl-6 space-y-1 text-amber-700 text-sm">
              <li>Introductie</li>
              <li>Principes van antimicrobiele therapie</li>
              <li>Farmacokinetiek</li>
              <li>Farmacodynamiek</li>
          ...
          <div className="p-5 bg-slate-50 rounded-xl border border-slate-200">
            ...
            <p className="text-slate-600 text-sm m-0">
              Het doornemen van deze module kost ongeveer 1 uur (zonder optionele zelfstudiemogelijkheden).
            </p>
          </div>
        </div>
      </section>
