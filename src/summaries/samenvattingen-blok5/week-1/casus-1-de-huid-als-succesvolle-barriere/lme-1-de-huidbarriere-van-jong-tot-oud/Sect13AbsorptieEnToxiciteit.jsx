export default function Sect13AbsorptieEnToxiciteit() {
  return (
    <div className="space-y-6 text-slate-700 dark:text-slate-300 leading-relaxed">
      <h2 className="text-xl font-bold text-slate-900 dark:text-slate-100">Absorptie en toxiciteit</h2>
      <p>
        Bij prematuren en ook bij à terme neonaten is de huid gevoeliger voor absorptie van stoffen. Dit hangt af van:
      </p>
      <ul className="list-disc pl-6 space-y-2">
        <li>leeftijd</li>
        <li>lichaamsregio</li>
        <li>de huidbarrière</li>
        <li>wat er op de huid gesmeerd wordt en hoe dat gebeurt, bijvoorbeeld door occlusie</li>
      </ul>
      <p>
