export default function Sect08Fractionering() {
  return (
    <div className="space-y-6 text-slate-700 dark:text-slate-300 leading-relaxed">
      <h2 className="text-xl font-bold text-slate-900 dark:text-slate-100">
        Fractionering: waarom wordt bestraling verdeeld in delen?
      </h2>
      <p>
        Radiotherapie wordt meestal niet in één keer gegeven, maar verdeeld in kleinere hoeveelheden, die fracties
