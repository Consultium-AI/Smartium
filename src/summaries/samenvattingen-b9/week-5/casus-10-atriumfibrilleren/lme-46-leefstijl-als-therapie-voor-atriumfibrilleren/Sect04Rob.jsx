export default function Sect04Rob() {
  return (
    <div className="space-y-6 text-slate-700 dark:text-slate-300 leading-relaxed">
      <h2 className="text-xl font-bold text-slate-900 dark:text-slate-100">Rob: leefstijl als onderdeel van de behandeling</h2>
      <p>
        Rob is een patiënt bij wie atriumfibrilleren speelt in een herkenbare context. Hij drinkt regelmatig alcohol, beweegt weinig, heeft overgewicht en heeft mogelijk ook andere risicofactoren zoals hoge bloeddruk en slaapapneu. In zijn verhaal zie je hoe leefstijl en atriumfibrilleren samenkomen.
      </p>
      <p>
