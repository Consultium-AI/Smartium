...
const Image01IntroductieSummary = () => {
  ...
  return (
    <SummaryLayout
      ...
      practiceLink="/oefenvragen?lme=lme5-schimmelinfecties-image01"
    >
      <section id="intro" className="scroll-mt-24 mb-12">
        ...
        <div className="text-slate-700 space-y-4 leading-relaxed">
          <div className="p-5 bg-primary-50 rounded-xl border border-primary-200">
            ...
            <p className="text-primary-700 mb-2">Als je deze module hebt doorgenomen:</p>
            <ul className="list-disc pl-6 space-y-1 text-primary-700 text-sm">
              <li>Ken je de benaming van schimmelinfecties van de huid, nagels en haren</li>
              <li>Ken je de symptomen en klinische presentatie</li>
              <li>Ken je opties tot diagnostiek</li>
              <li>Heb je een globaal idee van het beleid</li>
            </ul>
          </div>
          ...
          <div className="p-5 bg-teal-50 rounded-xl border border-teal-200">
            ...
            <p className="text-teal-700 text-sm m-0">
              Deze module richt zich op studenten in de bachelor Geneeskunde in het eerste jaar.
            </p>
          </div>
          ...
          <div className="p-5 bg-amber-50 rounded-xl border border-amber-200">
            ...
            <ul className="list-disc pl-6 space-y-1 text-amber-700 text-sm">
              <li>Hoofdstuk 1: Inleiding</li>
              <li>Hoofdstuk 2: Voorkomen</li>
              <li>Hoofdstuk 3: Klachten en symptomen</li>
              <li>Hoofdstuk 4: Herkenning</li>
              <li>Hoofdstuk 5: Diagnostiek</li>
              <li>Hoofdstuk 6: Behandeling</li>
            </ul>
          </div>
          ...
          <div className="p-5 bg-slate-50 rounded-xl border border-slate-200">
            ...
            <p className="text-slate-600 text-sm m-0">
              Het doornemen van deze module kost ongeveer 40 minuten.
            </p>
          </div>
        </div>
      </section>
