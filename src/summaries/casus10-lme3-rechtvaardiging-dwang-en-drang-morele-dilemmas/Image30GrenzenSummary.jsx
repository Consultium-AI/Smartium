...
const Image30GrenzenSummary = () => {
  const toc = [{ id: 'grenzen', title: 'Grenzen', icon: Shield }]
  return (
    <SummaryLayout title="Grenzen" description="De grenzen van dwang en drang bij vaccinatie." caseLabel="Week 5 Casus 10 LME 3: Afbeelding 30" tableOfContents={toc} practiceLink="/oefenvragen?lme=casus10-lme3-rechtvaardiging-dwang-en-drang-morele-dilemmas-image30">
