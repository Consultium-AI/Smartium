...
const Image31VerantwoordelijkheidSummary = () => {
  const toc = [{ id: 'verantwoordelijkheid', title: 'Verantwoordelijkheid', icon: Target }]
  return (
    <SummaryLayout title="Verantwoordelijkheid" description="Verantwoordelijkheden bij vaccinatie en morele dilemma's." caseLabel="Week 5 Casus 10 LME 3: Afbeelding 31" tableOfContents={toc} practiceLink="/oefenvragen?lme=casus10-lme3-rechtvaardiging-dwang-en-drang-morele-dilemmas-image31">
