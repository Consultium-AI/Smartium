...
const Image15ReflectieSummary = () => {
  const toc = [{ id: 'reflectie', title: 'Reflectie', icon: MessageCircle }]
  return (
    <SummaryLayout title="Reflectie" description="Terugblik op morele dilemma's." caseLabel="Week 5 Casus 10 LME 3: Afbeelding 15" tableOfContents={toc} practiceLink="/oefenvragen?lme=casus10-lme3-rechtvaardiging-dwang-en-drang-morele-dilemmas-image15">
