...
const Image24WetgevingSummary = () => {
  const toc = [{ id: 'wetgeving', title: 'Wetgeving', icon: Scale }]
  return (
    <SummaryLayout title="Wetgeving" description="De juridische kaders voor vaccinatie en dwang." caseLabel="Week 5 Casus 10 LME 3: Afbeelding 24" tableOfContents={toc} practiceLink="/oefenvragen?lme=casus10-lme3-rechtvaardiging-dwang-en-drang-morele-dilemmas-image24">
