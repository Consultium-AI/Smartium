...
const Image26RisicocommunicatieSummary = () => {
  const toc = [{ id: 'risicocommunicatie', title: 'Risicocommunicatie', icon: HelpCircle }]
  return (
    <SummaryLayout title="Risicocommunicatie" description="Effectief communiceren over risico's van vaccinatie." caseLabel="Week 5 Casus 10 LME 3: Afbeelding 26" tableOfContents={toc} practiceLink="/oefenvragen?lme=casus10-lme3-rechtvaardiging-dwang-en-drang-morele-dilemmas-image26">
