...
const Image27AlternatievenSummary = () => {
  const toc = [{ id: 'alternatieven', title: 'Alternatieven', icon: Layers }]
  return (
    <SummaryLayout title="Alternatieven" description="Alternatieven voor dwang en drang bij vaccinatie." caseLabel="Week 5 Casus 10 LME 3: Afbeelding 27" tableOfContents={toc} practiceLink="/oefenvragen?lme=casus10-lme3-rechtvaardiging-dwang-en-drang-morele-dilemmas-image27">
