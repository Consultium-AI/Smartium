...
const Image23MaatschappelijkDebatSummary = () => {
  const toc = [{ id: 'maatschappelijk-debat', title: 'Maatschappelijk debat', icon: MessageCircle }]
  return (
    <SummaryLayout title="Maatschappelijk debat" description="Het maatschappelijke debat over vaccinatie en dwang." caseLabel="Week 5 Casus 10 LME 3: Afbeelding 23" tableOfContents={toc} practiceLink="/oefenvragen?lme=casus10-lme3-rechtvaardiging-dwang-en-drang-morele-dilemmas-image23">
