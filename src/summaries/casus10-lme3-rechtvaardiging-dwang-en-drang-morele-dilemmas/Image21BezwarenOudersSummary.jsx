...
const Image21BezwarenOudersSummary = () => {
  const toc = [{ id: 'bezwaren-ouders', title: 'Bezwaren ouders', icon: User }]
  return (
    <SummaryLayout title="Bezwaren ouders" description="Omgaan met bezwaren van ouders tegen vaccinatie." caseLabel="Week 5 Casus 10 LME 3: Afbeelding 21" tableOfContents={toc} practiceLink="/oefenvragen?lme=casus10-lme3-rechtvaardiging-dwang-en-drang-morele-dilemmas-image21">
