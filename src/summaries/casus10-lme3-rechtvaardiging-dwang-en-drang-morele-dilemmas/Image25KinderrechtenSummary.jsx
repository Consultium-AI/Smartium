...
const Image25KinderrechtenSummary = () => {
  const toc = [{ id: 'kinderrechten', title: 'Kinderrechten', icon: Users }]
  return (
    <SummaryLayout title="Kinderrechten" description="Het belang van het kind en kinderrechten bij vaccinatie." caseLabel="Week 5 Casus 10 LME 3: Afbeelding 25" tableOfContents={toc} practiceLink="/oefenvragen?lme=casus10-lme3-rechtvaardiging-dwang-en-drang-morele-dilemmas-image25">
