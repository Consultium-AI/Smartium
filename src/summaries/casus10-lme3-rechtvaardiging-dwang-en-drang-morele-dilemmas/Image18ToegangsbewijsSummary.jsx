...
const Image18ToegangsbewijsSummary = () => {
  const toc = [{ id: 'toegang', title: 'Toegangsbewijs', icon: FileText }]
  return (
    <SummaryLayout title="Toegangsbewijs" description="Corona-toegangsbewijs als vorm van drang." caseLabel="Week 5 Casus 10 LME 3: Afbeelding 18" tableOfContents={toc} practiceLink="/oefenvragen?lme=casus10-lme3-rechtvaardiging-dwang-en-drang-morele-dilemmas-image18">
