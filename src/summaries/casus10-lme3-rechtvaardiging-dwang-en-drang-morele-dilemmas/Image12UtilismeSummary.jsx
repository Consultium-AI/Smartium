...
const Image12UtilismeSummary = () => {
  const toc = [{ id: 'utilisme', title: 'Utilisme', icon: BarChart3 }]
  return (
    <SummaryLayout title="Utilisme" description="Het grootste goed voor het grootste aantal." caseLabel="Week 5 Casus 10 LME 3: Afbeelding 12" tableOfContents={toc} practiceLink="/oefenvragen?lme=casus10-lme3-rechtvaardiging-dwang-en-drang-morele-dilemmas-image12">
