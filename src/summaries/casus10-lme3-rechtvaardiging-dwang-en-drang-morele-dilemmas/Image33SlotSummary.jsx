...
const Image33SlotSummary = () => {
  const toc = [{ id: 'slot', title: 'Slot', icon: Target }]
  return (
    <SummaryLayout title="Slot" description="Afsluiting van de module." caseLabel="Week 5 Casus 10 LME 3: Afbeelding 33" tableOfContents={toc} practiceLink="/oefenvragen?lme=casus10-lme3-rechtvaardiging-dwang-en-drang-morele-dilemmas-image33">
