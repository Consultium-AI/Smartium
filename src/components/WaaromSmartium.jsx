    ...
    >
      ...
      <div className="container-custom py-24 md:py-32">
        <div className="max-w-4xl mx-auto text-center mb-12 md:mb-16">
          ...
          <h2 className="font-display text-4xl sm:text-5xl md:text-6xl font-semibold text-navy-900 dark:text-slate-50 tracking-tight leading-[1.05] mb-7">
        ...
        <div className="max-w-5xl mx-auto text-center space-y-8 md:space-y-10">
          <p className="text-lg md:text-2xl text-navy-600 dark:text-slate-200 leading-relaxed">
