# -*- coding: utf-8 -*-
"""One-shot: extract LME41 docx to .cursor/lme41_structure.json for section generator."""
import json
import os
import sys
import zipfile
...
DEFAULT_DOCX = os.path.join(
    ...
    'Week 5',
    'Casus C10_DM_type2',
    'LME41 - _Symptomen_pathofysiologie_diagnostiek_DM2.docx',
)
OUT_JSON = os.path.join(ROOT, '.cursor', 'lme41_structure.json')
