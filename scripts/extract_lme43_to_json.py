# -*- coding: utf-8 -*-
"""Extract LME43 docx to .cursor/lme43_structure.json for section generator."""
import json
import os
import sys
import zipfile
...
DEFAULT_DOCX = os.path.join(
    ...
    'Week 5',
    'Casus C10_DM_type2',
    'LME43 - _Leefstijl_voeding_preventie_DM2.docx',
)
OUT_JSON = os.path.join(ROOT, '.cursor', 'lme43_structure.json')
