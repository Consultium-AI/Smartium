# -*- coding: utf-8 -*-
"""Extract LME42 docx to .cursor/lme42_structure.json for section generator."""
import json
import os
import sys
import zipfile
...
DEFAULT_DOCX = os.path.join(
    ...
    'Week 5',
    'Casus C10_DM_type2',
    'LME42 - _Langetermijn_complicaties_diabetes.docx',
)
OUT_JSON = os.path.join(ROOT, '.cursor', 'lme42_structure.json')
