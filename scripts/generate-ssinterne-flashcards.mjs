#!/usr/bin/env node
/**
 * Genereer SSInterne Anki-flashcards (layer 1 / draft) uit de al gegenereerde
 * samenvattingen (.cursor/ssinterne-cache/week-N/<slug>/raw.md), met de
 * SMARTIUM ANKI CARD GENERATOR (layer 1) masterprompt. Zelfde patroon als
 * generate-sskindgyn-flashcards.mjs.
 *
 * Output: .cursor/ssinterne-cache/week-N/<slug>/flashcards-draft.json
 * (layer 2 reviewer leest dit bestand en schrijft pas de publieke deck)
 *
 * Usage:
 *   node scripts/generate-ssinterne-flashcards.mjs --list
 *   node scripts/generate-ssinterne-flashcards.mjs --module ecg
 *   node scripts/generate-ssinterne-flashcards.mjs --all --skip-existing
 */
import fs from 'fs'
